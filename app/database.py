...
from app.settings import DEFAULT_LANGUAGE, g, product_version, tests_count
...
class RedisStorage:
    ...
    def set(self, name, key, value, mapping=None):
    ...
    def get_lang(self, name):
        lang = self.get(name, 'lang')
        return lang and lang.decode() or DEFAULT_LANGUAGE
