...
_RESULTS = {
    'ru' : {
        '01' : [(10, 'Обнаружено крайне низкое значение психоэмоционального истощения'), (20, 'Обнаружено низкое значение психоэмоционального истощения'), (30, 'Обнаружено среднее значение психоэмоционального истощения'), (40, 'Обнаружено высокое значение психоэмоционального истощения'), (54, 'Обнаружено крайне высокое значение психоэмоционального истощения'),],
        '02' : [(5, 'Обнаружено крайне низкое значение деперсонализации (личностного отдаления)'), (11, 'Обнаружено низкое значение деперсонализации (личностного отдаления)'), (17, 'Обнаружено среднее значение деперсонализации (личностного отдаления)'), (23, 'Обнаружено высокое значение деперсонализации (личностного отдаления)'), (30, 'Обнаружено крайне высокое значение деперсонализации (личностного отдаления)'),],
        '03' : [(8, 'Обнаружено крайне высокое значение редукции личных достижений (профессиональной мотивации)'), (18, 'Обнаружено высокое значение редукции личных достижений (профессиональной мотивации)'), (28, 'Обнаружено среднее значение редукции личных достижений (профессиональной мотивации)'), (38, 'Обнаружено низкое значение редукции личных достижений (профессиональной мотивации)'), (48, 'Обнаружено крайне низкое значение редукции личных достижений (профессиональной мотивации)'),],
    },
    'ua' : {
        '01' : [(10, 'Виявлено вкрай низьке значення психоемоційного виснаження'), (20, 'Виявлено низьке значення психоемоційного виснаження'), (30, 'Виявлено середнє значення психоемоційного виснаження'), (40, 'Виявлено високе значення психоемоційного виснаження'), (54, 'Виявлено вкрай високе значення психоемоційного виснаження'),],
        '02' : [(5, 'Виявлено вкрай низьке значення деперсоналізації (особистісної віддаленості'), (11, 'Виявлено низьке значення деперсоналізації (особистісної віддаленості)'), (17, 'Виявлено середнє значення деперсоналізації (особистісної віддаленості)'), (23, 'Виявлено високе значення деперсоналізації (особистісної віддаленості)'), (30, 'Виявлено вкрай високе значення деперсоналізації (особистісної віддаленості)'),],
        '03' : [(8, 'Виявлено вкрай високе значення психоемоційного виснаження'), (18, 'Виявлено високе значення психоемоційного виснаження'), (28, 'Виявлено середнє значення психоемоційного виснаження'), (38, 'Виявлено низьке значення психоемоційного виснаження'), (48, 'Виявлено вкрай низьке значення психоемоційного виснаження'),],
    },
}
...
def answer(bot, message, command, data=None, logger=None, question=None, **kw):
    ...
    if question == 22 or (IsDebug and question > 0 and question%10 == 0):
    ...
    if is_run:
        ...
        for p, sc in sorted([x for x in _PARAMS[lang].keys()]):
            if p in _results:
                storage.set(name, '%s.RP%s' % (_TEST_NAME, p), _results[p][0])

        storage.set(name, '%s.RF' % _TEST_NAME, _results['value'])
