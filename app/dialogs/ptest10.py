...
_CONCLUSIONS = {
    'ru' : {
        '1' : ('Реактивная тревожность', [(31, 'Обнаружен низкий уровень тревожности'), (45, 'Обнаружен умеренный уровень тревожности'), (999, 'Обнаружен высокий уровень тревожности')]),
        '2' : ('Личностная тревожность', [(31, 'Обнаружен низкий уровень тревожности'), (45, 'Обнаружен умеренный уровень тревожности'), (999, 'Обнаружен высокий уровень тревожности')]),
    },
    'ua' : {
        '1' : ('Реактивна тривожність', [(31, 'Виявлено низький рівень тривожності'), (45, 'Виявлено помірний рівень тривожності'), (999, 'Виявлено високий рівень тривожності')]),
        '2' : ('Особистісна тривожність', [(31, 'Виявлено низький рівень тривожності'), (45, 'Виявлено помірний рівень тривожності'), (999, 'Виявлено високий рівень тривожності')]),
    },
}
...
def answer(bot, message, command, data=None, logger=None, question=None, **kw):
    ...
    if question == 40 or (IsDebug and question > 0 and question%10 == 0):
    ...
    if is_run:
        ...
        for p in sorted([x for x in _RESULTS[lang].keys()]):
            if p in _results:
                storage.set(name, '%s.R%s' % (_TEST_NAME, p), _results[p])
