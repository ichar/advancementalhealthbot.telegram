...
_ANSWERS = ({
    ...
    'ua': (('увесь час', 'T1.1:3'), ('часто', 'T1.1:2'), ('час від часу, іноді', 'T1.1:1'), ('зовсім не відчуваю', 'T1.1:0')),
}, {
    ...
    'ua': (('безперечно, це так, і страх дуже великий', 'T1.2:3'), ('так, це так, але страх не дуже великий', 'T1.2:2'), ('іноді, але це мене не турбує', 'T1.2:1'), ('зовсім не відчуваю', 'T1.2:0')),
}, {
    'ru': (('постоянно', 'T1.3:3'), ('большую часть времени', 'T1.3:2'), ('время от времени и не так часто', 'T1.3:1'), ('только иногда', 'T1.3:0')),
    'ua': (('постійно', 'T1.3:3'), ('більшу частину часу', 'T1.3:2'), ('час від часу і не так часто', 'T1.3:1'), ('лише іноді', 'T1.3:0')),
}, {
    'ru': (('определенно, это так', 'T1.4:0'), ('наверно, это так', 'T1.4:1'), ('лишь изредка, это так', 'T1.4:2'), ('совсем не могу', 'T1.4:3')),
    'ua': (('безперечно, це так', 'T1.4:0'), ('мабуть, це так', 'T1.4:1'), ('лише іноді це так', 'T1.4:2'), ('зовсім не можу', 'T1.4:3')),
}, {
    'ru': (('совсем не испытываю', 'T1.5:0'), ('иногда', 'T1.5:1'), ('часто', 'T1.5:2'), ('очень часто', 'T1.5:3')),
    'ua': (('зовсім не відчуваю', 'T1.5:0'), ('іноді', 'T1.5:1'), ('часто', 'T1.5:2'), ('дуже часто', 'T1.5:3')),
}, {
    'ru': (('определенно, это так', 'T1.6:3'), ('наверно, это так', 'T1.6:2'), ('лишь в некоторой степени, это так', 'T1.6:1'), ('совсем не испытываю', 'T1.6:0')),
    'ua': (('безперечно, це так', 'T1.6:3'), ('мабуть, це так', 'T1.6:2'), ('лише певною мірою це так', 'T1.6:1'), ('зовсім не відчуваю', 'T1.6:0')),
}, {
    'ru': (('очень часто', 'T1.7:3'), ('довольно часто', 'T1.7:2'), ('не так уж часто', 'T1.7:1'), ('совсем не бывает', 'T1.7:0')),
    'ua': (('дуже часто', 'T1.7:3'), ('досить часто', 'T1.7:2'), ('не так вже й часто', 'T1.7:1'), ('зовсім не буває', 'T1.7:0')),
}, {
    'ru': (('определенно, это так', 'T1.8:0'), ('наверное, это так', 'T1.8:1'), ('лишь в очень малой степени, это так', 'T1.8:2'), ('это совсем не так', 'T1.8:3')),
    'ua': (('безперечно, це так', 'T1.8:0'), ('мабуть, це так', 'T1.8:1'), ('лише малою мірою це так', 'T1.8:2'), ('це зовсім не так', 'T1.8:3')),
}, {
    ...
    'ua': (('безперечно, це так', 'T1.9:0'), ('мабуть, це так', 'T1.9:1'), ('лише малою мірою це так', 'T1.9:2'), ('це зовсім не так', 'T1.9:3')),
}, {
    'ru': (('совсем не испытываю', 'T1.10:3'), ('очень редко', 'T1.10:2'), ('иногда', 'T1.10:1'), ('практически все время', 'T1.10:0')),
    'ua': (('зовсім не відчуваю', 'T1.10:3'), ('дуже рідко', 'T1.10:2'), ('іноді', 'T1.10:1'), ('практично увесь час', 'T1.10:0')),
}, {
    'ru': (('практически все время', 'T1.11:3'), ('часто', 'T1.11:2'), ('иногда', 'T1.11:1'), ('совсем нет', 'T1.11:0')),
    'ua': (('практично увесь час', 'T1.11:3'), ('часто', 'T1.11:2'), ('іноді', 'T1.11:1'), ('зовсім ні', 'T1.11:0')),
}, {
    ...
    'ua': (('безперечно, це так', 'T1.12:3'), ('я не приділяю цьому стільки уваги, скільки потрібно', 'T1.12:2'), ('можливо, я став приділяти цьому менше уваги', 'T1.12:1'), ('я стежу за собою, як і раніше', 'T1.12:0')),
}, {
    ...
    'ua': (('точно так само, як і зазвичай', 'T1.13:0'), ('так, але не тією ж мірою, як раніше', 'T1.13:1'), ('значно менше, ніж зазвичай', 'T1.13:2'), ('зовсім так не вважаю', 'T1.13:3')),
}, {
    'ru': (('часто', 'T1.14:0'), ('иногда', 'T1.14:1'), ('редко', 'T1.14:2'), ('очень редко', 'T1.14:3')),
    'ua': (('часто', 'T1.14:0'), ('іноді', 'T1.14:1'), ('зрідка', 'T1.14:2'), ('дуже рідко', 'T1.14:3')),
})
...
_RESULTS = {
    'ru': {
        '1' : ['Оценка уровня тревожности', ((7, 'У Вас нет никаких особых проблем с тревожностью, с которой Вы бы не смогли справиться самостоятельно, психологическая помощь не требуется'), (10, 'В наличии субклинически выраженная тревожность, вероятно, имеет смысл обратиться за помощью к психологу'), (99, 'В наличии клинически выраженная тревожность, настоятельно рекомендуется обратиться к специалисту'))],
        '2' : ['Оценка уровня депрессии', ((7, 'У Вас нет никаких особых проблем с депрессией, с которой Вы бы не смогли справиться самостоятельно, психологическая помощь не требуется'), (10, 'В наличии субклинически выраженная депрессия, вероятно, имеет смысл обратиться за помощью к психологу'), (99, 'В наличии клинически выраженная депрессия, настоятельно рекомендуется обратиться к специалисту'))],
    },
    'ua': {
        '1' : ['Оцінка рівня тривожності', ((7, 'У Вас немає жодних особливих психологічних проблем, які би Ви не могли здолати самостійно, психологічна допомога не потрібна'), (10, 'В наявності субклінічно виражена тривожність, ймовірно, має сенс звернутися за допомогою до психолога'), (99, 'В наявності клінічно виражена тривожність, наполегливо рекомендується звернутися до психолога'))],
        '2' : ['Оцінка рівня депресії', ((7, 'У вас немає жодних особливих психологічних проблем, які би ви не могли здолати самостійно, психологічна допомога не потрібна'), (10, 'В наявності субклінічно виражена депресія , ймовірно, має сенс звернутися за допомогою до психолога'), (99, 'В наявності клінічно виражена депресія, наполегливо рекомендується звернутися до психолога'))],
    },
}
