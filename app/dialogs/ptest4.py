...
_RESULTS = {
    'ru' : (
        ...
        (18, 'Обнаружено низкий уровень тревожности'), 
        (29, 'Выявлен средний уровень тревожности'), 
        (63, 'Выявлено высокий уровень тревожности, клиническое проявление. Настоятельно рекомендуется обратиться к специалисту'), 
    ),
    'ua' : (
        ( 9, 'Симптоми тривожності відсутні'), 
        (18, 'Виявлено низький рівень тривожності'), 
        (29, 'Виявлено середній рівень тривожності'), 
        (63, 'Виявлено високий рівень тривожності, клінічне проявлення. Наполегливо рекомендується звернутися до фахівця'), 
    ),
}
