...
_CONCLUSIONS = {
    'ru' : (
        (49, 'Обнаружено состояние без депрессии'), 
        (59, 'Обнаружена лёгкая депрессия ситуативного или невротического генеза'), 
        (69, 'Обнаружено субдепрессивное состояние или замаскированная депрессия'), 
        (80, 'Обнаружена тяжёлая депрессия'), 
    ),
    'ua' : (
        (49, 'Виявлено стан без депресії'), 
        (59, 'Виявлена легка депресія ситуативного чи невротичного генезу'), 
        (69, 'Виявлено субдепресивний стан чи замасковану депресію'), 
        (80, 'Виявлено важку депресію'), 
    ),
}
...
def answer(bot, message, command, data=None, logger=None, question=None, **kw):
    ...
    if question == 20 or (IsDebug and question > 0 and question%10 == 0):
