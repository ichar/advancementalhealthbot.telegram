...
_CONCLUSIONS = {
    'ru' : {
        '0' : ('Искренность', [(1, 'Высокая искренность'), (3, 'Средняя искренность'), (7, 'Низкая искренность (ответы ненадёжные)')]),
        '1' : ('Тревожность', [(5, 'Обнаружен низкий уровень тревоги'), (15, 'Обнаружен средний (с тенденцией к низкому) уровень тревоги'), (25, 'Обнаружен средний (с тенденцией к высокому) уровень тревоги'), (40, 'Обнаружен высокий уровень тревоги'), (50, 'Обнаружен очень высокий уровень тревоги'),]),
    },
    'ua' : {
...
def answer(bot, message, command, data=None, logger=None, question=None, **kw):
    ...
    if question == 60 or (IsDebug and question > 0 and question%10 == 0):
